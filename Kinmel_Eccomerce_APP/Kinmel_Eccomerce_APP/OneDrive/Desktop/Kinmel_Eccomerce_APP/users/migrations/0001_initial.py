    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('trader', 'Trader'), ('customer', 'Customer')], default='customer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('violation_type', models.CharField(choices=[('fake_product', 'Fake Product'), ('poor_service', 'Poor Service'), ('delayed_shipping', 'Delayed Shipping'), ('policy_violation', 'Policy Violation'), ('customer_complaint', 'Customer Complaint'), ('other', 'Other')], max_length=20)),
                ...
                ('trader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='violations', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
